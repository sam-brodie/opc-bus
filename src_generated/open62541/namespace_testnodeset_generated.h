...
#ifndef NAMESPACE_TESTNODESET_GENERATED_H_
#define NAMESPACE_TESTNODESET_GENERATED_H_
...
extern UA_StatusCode namespace_testnodeset_generated(UA_Server *server);

_UA_END_DECLS

#endif /* NAMESPACE_TESTNODESET_GENERATED_H_ */
