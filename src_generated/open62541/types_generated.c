...
/* Handle */
#define Handle_members NULL

/* TrimmedString */
#define TrimmedString_members NULL
...
/* AlarmMask */
#define AlarmMask_members NULL

/* TrustListValidationOptions */
#define TrustListValidationOptions_members NULL
...
static UA_DataTypeMember TransactionErrorType_members[3] = {
{
...
},
{
    ...
    offsetof(UA_TransactionErrorType, error) - offsetof(UA_TransactionErrorType, targetId) - sizeof(UA_NodeId), /* .padding */
    false, /* .isArray */
    false  /* .isOptional */
},
{
    ...
    &UA_TYPES[UA_TYPES_LOCALIZEDTEXT], /* .memberType */
    offsetof(UA_TransactionErrorType, message) - offsetof(UA_TransactionErrorType, error) - sizeof(UA_StatusCode), /* .padding */
    false, /* .isArray */
    false  /* .isOptional */
},};
...
/* EncodedTicket */
#define EncodedTicket_members NULL
...
static UA_DataTypeMember ReferenceDescriptionDataType_members[4] = {
{
    UA_TYPENAME("SourceNode") /* .memberName */
    &UA_TYPES[UA_TYPES_NODEID], /* .memberType */
    0, /* .padding */
    false, /* .isArray */
    false  /* .isOptional */
...
{
    UA_TYPENAME("ReferenceType") /* .memberName */
    &UA_TYPES[UA_TYPES_NODEID], /* .memberType */
    offsetof(UA_ReferenceDescriptionDataType, referenceType) - offsetof(UA_ReferenceDescriptionDataType, sourceNode) - sizeof(UA_NodeId), /* .padding */
    false, /* .isArray */
    false  /* .isOptional */
},
{
    ...
    &UA_TYPES[UA_TYPES_BOOLEAN], /* .memberType */
    offsetof(UA_ReferenceDescriptionDataType, isForward) - offsetof(UA_ReferenceDescriptionDataType, referenceType) - sizeof(UA_NodeId), /* .padding */
    false, /* .isArray */
    false  /* .isOptional */
},
{
    UA_TYPENAME("TargetNode") /* .memberName */
    &UA_TYPES[UA_TYPES_EXPANDEDNODEID], /* .memberType */
    offsetof(UA_ReferenceDescriptionDataType, targetNode) - offsetof(UA_ReferenceDescriptionDataType, isForward) - sizeof(UA_Boolean), /* .padding */
    false, /* .isArray */
    false  /* .isOptional */
},};

/* ReferenceListEntryDataType */
static UA_DataTypeMember ReferenceListEntryDataType_members[3] = {
{
    UA_TYPENAME("ReferenceType") /* .memberName */
    &UA_TYPES[UA_TYPES_NODEID], /* .memberType */
    0, /* .padding */
...
},
{
    UA_TYPENAME("IsForward") /* .memberName */
    &UA_TYPES[UA_TYPES_BOOLEAN], /* .memberType */
    offsetof(UA_ReferenceListEntryDataType, isForward) - offsetof(UA_ReferenceListEntryDataType, referenceType) - sizeof(UA_NodeId), /* .padding */
    false, /* .isArray */
    false  /* .isOptional */
},
{
    UA_TYPENAME("TargetNode") /* .memberName */
    &UA_TYPES[UA_TYPES_EXPANDEDNODEID], /* .memberType */
    offsetof(UA_ReferenceListEntryDataType, targetNode) - offsetof(UA_ReferenceListEntryDataType, isForward) - sizeof(UA_Boolean), /* .padding */
    false, /* .isArray */
    false  /* .isOptional */
},};
...
/* Handle */
{
    UA_TYPENAME("Handle") /* .typeName */
    {0, UA_NODEIDTYPE_NUMERIC, {31917LU}}, /* .typeId */
    {0, UA_NODEIDTYPE_NUMERIC, {0}}, /* .binaryEncodingId */
    sizeof(UA_Handle), /* .memSize */
    UA_DATATYPEKIND_BYTESTRING, /* .typeKind */
    false, /* .pointerFree */
    false, /* .overlayable */
    0, /* .membersSize */
    Handle_members  /* .members */
},
/* TrimmedString */
{
    UA_TYPENAME("TrimmedString") /* .typeName */
    {0, UA_NODEIDTYPE_NUMERIC, {31918LU}}, /* .typeId */
    {0, UA_NODEIDTYPE_NUMERIC, {0}}, /* .binaryEncodingId */
    sizeof(UA_TrimmedString), /* .memSize */
    UA_DATATYPEKIND_BYTESTRING, /* .typeKind */
    false, /* .pointerFree */
    false, /* .overlayable */
    0, /* .membersSize */
    TrimmedString_members  /* .members */
},
/* RationalNumber */
{
...
/* AlarmMask */
{
    UA_TYPENAME("AlarmMask") /* .typeName */
    {0, UA_NODEIDTYPE_NUMERIC, {32251LU}}, /* .typeId */
    {0, UA_NODEIDTYPE_NUMERIC, {0}}, /* .binaryEncodingId */
    sizeof(UA_AlarmMask), /* .memSize */
    UA_DATATYPEKIND_UINT16, /* .typeKind */
    true, /* .pointerFree */
    UA_BINARY_OVERLAYABLE_INTEGER, /* .overlayable */
    0, /* .membersSize */
    AlarmMask_members  /* .members */
},
/* TrustListValidationOptions */
{
    UA_TYPENAME("TrustListValidationOptions") /* .typeName */
    {0, UA_NODEIDTYPE_NUMERIC, {23564LU}}, /* .typeId */
    {0, UA_NODEIDTYPE_NUMERIC, {0}}, /* .binaryEncodingId */
    sizeof(UA_TrustListValidationOptions), /* .memSize */
    UA_DATATYPEKIND_UINT32, /* .typeKind */
    true, /* .pointerFree */
    UA_BINARY_OVERLAYABLE_INTEGER, /* .overlayable */
    0, /* .membersSize */
    TrustListValidationOptions_members  /* .members */
},
/* TrustListMasks */
{
...
/* TransactionErrorType */
{
    UA_TYPENAME("TransactionErrorType") /* .typeName */
    {0, UA_NODEIDTYPE_NUMERIC, {32285LU}}, /* .typeId */
    {0, UA_NODEIDTYPE_NUMERIC, {32382LU}}, /* .binaryEncodingId */
    sizeof(UA_TransactionErrorType), /* .memSize */
    UA_DATATYPEKIND_STRUCTURE, /* .typeKind */
    false, /* .pointerFree */
    false, /* .overlayable */
    3, /* .membersSize */
    TransactionErrorType_members  /* .members */
},
/* DataTypeDescription */
{
...
/* EncodedTicket */
{
    UA_TYPENAME("EncodedTicket") /* .typeName */
    {0, UA_NODEIDTYPE_NUMERIC, {25726LU}}, /* .typeId */
    {0, UA_NODEIDTYPE_NUMERIC, {0}}, /* .binaryEncodingId */
    sizeof(UA_EncodedTicket), /* .memSize */
    UA_DATATYPEKIND_BYTESTRING, /* .typeKind */
    false, /* .pointerFree */
    false, /* .overlayable */
    0, /* .membersSize */
    EncodedTicket_members  /* .members */
},
/* Duplex */
{
...
/* ReferenceDescriptionDataType */
{
    UA_TYPENAME("ReferenceDescriptionDataType") /* .typeName */
    {0, UA_NODEIDTYPE_NUMERIC, {32659LU}}, /* .typeId */
    {0, UA_NODEIDTYPE_NUMERIC, {32661LU}}, /* .binaryEncodingId */
    sizeof(UA_ReferenceDescriptionDataType), /* .memSize */
    UA_DATATYPEKIND_STRUCTURE, /* .typeKind */
    false, /* .pointerFree */
    false, /* .overlayable */
    4, /* .membersSize */
    ReferenceDescriptionDataType_members  /* .members */
},
/* ReferenceListEntryDataType */
{
    UA_TYPENAME("ReferenceListEntryDataType") /* .typeName */
    {0, UA_NODEIDTYPE_NUMERIC, {32660LU}}, /* .typeId */
    {0, UA_NODEIDTYPE_NUMERIC, {32662LU}}, /* .binaryEncodingId */
    sizeof(UA_ReferenceListEntryDataType), /* .memSize */
    UA_DATATYPEKIND_STRUCTURE, /* .typeKind */
    false, /* .pointerFree */
    false, /* .overlayable */
    3, /* .membersSize */
    ReferenceListEntryDataType_members  /* .members */
},
/* IdType */
{
