...
//    //UA_ByteString certificate = loadFile("../../../testCerts/Quickstart_Reference_Server.crt");
...
//    //retval = UA_Client_connect(client, "opc.tcp://DESKTOP-AQHFLE3:48030/");
//    if (retval != UA_STATUSCODE_GOOD) {
//        UA_Client_delete(client);
//        return EXIT_FAILURE;
//    }
...
//    const UA_NodeId nodeId_array_ten = UA_NODEID_NUMERIC(2, 6010);
//
//    for (int i = 0; i < 10; i++) {
//        //retval = UA_Client_readValueAttribute(client, nodeId, &value);
//        retval = UA_Client_readValueAttribute(client, nodeId_array_ten, &value);
//
//        /// <summary>
//        /// https://www.open62541.org/doc/1.3/types.html#array-handling
//        /// </summary>
//
//        if (retval == UA_STATUSCODE_GOOD &&
...
//
//        if (retval == UA_STATUSCODE_GOOD &&
//            UA_Variant_hasArrayType(&value, &UA_TYPES[UA_TYPES_DOUBLE]))
//        {
//            UA_Double dataArray[10];
//            std::copy((double*)value.data,
//                (double*)value.data + 10,
//                dataArray);
//            //(double*)value.data, 10
//
//            UA_LOG_INFO(UA_Log_Stdout, UA_LOGCATEGORY_USERLAND, "readValue: ");
//            for (double d : dataArray)
//                UA_LOG_INFO(UA_Log_Stdout, UA_LOGCATEGORY_USERLAND, "-%f", d);
