...
int main(int argc, char* argv[]) {
    ...
    //certificate = loadFile("../../../testCerts/samServer_3_1.crt");
    //privateKey = loadFile("../../../testCerts/sam_CA_root_private_key.pem");
    ...
    UA_StatusCode retval =
        UA_ServerConfig_setISOBUS(UA_Server_getConfig(server));
